	...
	callback: ({ message, interaction }) => {
		...
		if (message) {
			...
			const mHeads = new MessageEmbed()
				...
				.setDescription(
					':regional_indicator_h: :regional_indicator_e: :regional_indicator_a: :regional_indicator_d: :regional_indicator_s:'
				)
				.setFooter('' + mName)
				.setTimestamp();
			const mTails = new MessageEmbed()
				...
				.setTitle('__Flip a Coin.__')
				.setDescription(
					':regional_indicator_t: :regional_indicator_a: :regional_indicator_i: :regional_indicator_l: :regional_indicator_s:'
				)
				.setFooter('' + mName)
				.setTimestamp();
			if (val === '1') {
